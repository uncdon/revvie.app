...
def signup():
    ...
    try:
        ...
        logger.warning(f"[REFERRAL_SIGNUP] Signup for {new_business_id} — referral_code={ref_code!r}")
        if ref_code:
            try:
                ...
                logger.warning(f"[REFERRAL_SIGNUP] record_referral_signup completed for {ref_code} → {new_business_id}")
